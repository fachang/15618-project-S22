...
public class VGG16: NetworkModuleProtocol {
    ...
    public init(gpu: Bool = false) {
        ...
        self.layers = [
            Conv2DLayerImg2col(nInputChannels: 3, nOutputChannels: 64, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            Conv2DLayerImg2col(nInputChannels: 64, nOutputChannels: 64, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            maxpool,
            Conv2DLayerImg2col(nInputChannels: 64, nOutputChannels: 128, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            Conv2DLayerImg2col(nInputChannels: 128, nOutputChannels: 128, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            maxpool,
            Conv2DLayerImg2col(nInputChannels: 128, nOutputChannels: 256, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            Conv2DLayerImg2col(nInputChannels: 256, nOutputChannels: 256, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            Conv2DLayerImg2col(nInputChannels: 256, nOutputChannels: 256, bias: true,
            ...
            ReLu(gpu: gpu),
            maxpool,
            Conv2DLayerImg2col(nInputChannels: 256, nOutputChannels: 512, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            Conv2DLayerImg2col(nInputChannels: 512, nOutputChannels: 512, bias: true,
                        kernelSize: 3, strideHeight: 1, strideWidth: 1,
                        padding: 1, paddingMode: PaddingMode.zeros, gpu: gpu),
            ReLu(gpu: gpu),
            Conv2DLayerImg2col(nInputChannels: 512, nOutputChannels: 512, bias: true,
